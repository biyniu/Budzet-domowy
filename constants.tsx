...
export const DEFAULT_CATEGORIES = [
    { id: 'grocery', label: 'Spożywcze', color: 'bg-green-100 text-green-700' },
    { id: 'supplements', label: 'Suplementy', color: 'bg-blue-100 text-blue-700' },
    { id: 'allegro', label: 'Allegro/Online', color: 'bg-orange-100 text-orange-700' },
    { id: 'rtv', label: 'RTV/AGD', color: 'bg-gray-100 text-gray-700' },
    { id: 'fuel', label: 'Paliwo', color: 'bg-red-100 text-red-700' },
    { id: 'other', label: 'Inne', color: 'bg-purple-100 text-purple-700' }
];

// Simple Icon Components to avoid large libraries
export const Icons = {
    Home: (props: any) => (
    ...
    Wallet: (props: any) => (
         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M20 12V8H6a2 2 0 0 1-2-2c0-1.1.9-2 2-2h12v4"/><path d="M4 6v12c0 1.1.9 2 2 2h14v-4"/><path d="M18 12a2 2 0 0 0-2 2c0 1.1.9 2 2 2h4v-4h-4z"/></svg>
    ),
    Bank: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="3" y="21" width="18" height="2"/><path d="M5 21V7"/><path d="M19 21V7"/><path d="M10 9v4"/><path d="M14 9v4"/><rect x="2" y="3" width="20" height="4" rx="1"/></svg>
    ),
    Refresh: (props: any) => (
    ...
    ArrowDown: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/></svg>
    ),
    ArrowUp: (props: any) => (
    ...
    Cloud: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.5 19c0-1.7-1.3-3-3-3h-1.1c-.1-1.8-1.5-3.3-3.3-3.4H9.9C8.1 12.7 6.6 14.1 6.5 16H6c-2.2 0-4 1.8-4 4s1.8 4 4 4h11.5c2.5 0 4.5-2 4.5-4.5S20 15 17.5 15z"/></svg>
    ),
    CloudUpload: (props: any) => (
    ...
    CloudCheck: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="m9 15 2 2 4-4"/></svg>
    )
};
